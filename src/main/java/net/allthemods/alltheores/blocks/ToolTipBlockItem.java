...
public class ToolTipBlockItem  extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn){
        if((stack.getItem() == BlockList.ALUMINUM_ORE_ITEM.get()) || (stack.getItem() == BlockList.ALUMINUM_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.ALUMINUM_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.ALUMINUM_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.IRIDIUM_ORE_ITEM.get()) || (stack.getItem() == BlockList.IRIDIUM_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.IRIDIUM_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.IRIDIUM_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.LEAD_ORE_ITEM.get()) || (stack.getItem() == BlockList.LEAD_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.LEAD_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.LEAD_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.NICKEL_ORE_ITEM.get()) || (stack.getItem() == BlockList.NICKEL_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.NICKEL_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.NICKEL_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.OSMIUM_ORE_ITEM.get()) || (stack.getItem() == BlockList.OSMIUM_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.OSMIUM_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.OSMIUM_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.PLATINUM_ORE_ITEM.get()) || (stack.getItem() == BlockList.PLATINUM_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.PLATINUM_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.PLATINUM_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.SILVER_ORE_ITEM.get()) || (stack.getItem() == BlockList.SILVER_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.SILVER_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.SILVER_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.TIN_ORE_ITEM.get()) || (stack.getItem() == BlockList.TIN_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.TIN_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.TIN_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.URANIUM_ORE_ITEM.get()) || (stack.getItem() == BlockList.URANIUM_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.URANIUM_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.URANIUM_END_ORE_ITEM.get())) {
        ...
        if((stack.getItem() == BlockList.ZINC_ORE_ITEM.get())|| (stack.getItem() == BlockList.ZINC_SLATE_ORE_ITEM.get()) || (stack.getItem() == BlockList.ZINC_NETHER_ORE_ITEM.get()) || (stack.getItem() == BlockList.ZINC_END_ORE_ITEM.get())) {
